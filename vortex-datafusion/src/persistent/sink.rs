...
impl DataSink for VortexSink {
    ...
    async fn write_all(
        ...
        if self.target_file_size.is_none() || !self.config.table_partition_cols.is_empty() {
...
impl FileSink for VortexSink {
    ...
    async fn spawn_writer_tasks_and_join(
        ...
        // TODO(adamg): We can probably be better at signaling how much memory we're consuming.
